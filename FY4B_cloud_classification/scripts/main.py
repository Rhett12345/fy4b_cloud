...
def process_one_day(root, outdir, cfg, channels=None, max_time_diff_min=None):
    """处理一天目录"""
    ...
    for obs_time in l1b_times:
        ...
        # 匹配 L2 产品
        product_files = match_l2_products(
            obs_time, indices, l2_keys, max_minutes=max_time_diff_min
        )
